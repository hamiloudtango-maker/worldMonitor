...
import { refreshFeed } from '@/v2/lib/ai-feeds-api';
...
export default function AIFeedsView() {
  ...
  async function handleCreate() {
    const name = `Feed ${new Date().toLocaleDateString('fr-FR')}`;
    const feed = await add(name, '', { layers: [], model_layers: [] });
    handleSelect(feed);
  }
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center max-w-sm">
            ...
            <p className="text-[11px] text-slate-400 leading-relaxed mb-4">
              Créez un feed pour surveiller les sujets qui comptent.
            </p>
            <button
